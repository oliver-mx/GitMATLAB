...
L=input1(5);            % length of the PRO membrane [m]
% alpha = 2.5e-9;        
...
Pd_L =  43;              % pressure draw side at L (not need if coupled via ERD)
...
%% display figures
%fig=[0,0,0,0,0,0,1,1,0]; % f(i)=1 --> figure i will be displayed
