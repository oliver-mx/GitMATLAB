...
for j=1:21
    ...
    options = optimoptions('paretosearch','ParetoSetSize',100, 'InitialPoints',X_init,'Display','off', 'MaxFunctionEvaluations',10000, 'ParetoSetChangeTolerance',1e-5,'UseParallel', true);
...
scatter(Y2(1,:),Y2(2,:),'MarkerEdgeColor',[0 0 0],'MarkerFaceColor','b'); hold on
grid on; xlim([-5.501 -.5]); ylim([0 0.48]);view(2);
legend('Case1: \epsilon-constraint method', 'Case2: \epsilon-constraint method','Location', 'Northeast');
ylabel('FW [m^3/h]','FontSize',16);xlabel('SEC_{net} [kWh/m^3]','FontSize',16);
numColors = 21;
colors = parula(numColors); 
load("DATA_05.mat")
scatter(Y_05(1,:),Y_05(2,:),'MarkerEdgeColor','none','MarkerFaceColor',parula(1)); hold on
load("DATA_06.mat")
scatter(Y_06(1,:),Y_06(2,:),'MarkerEdgeColor','none','MarkerFaceColor',parula(2)); hold on
load("DATA_07.mat")
scatter(Y_07(1,:),Y_07(2,:),'MarkerEdgeColor','none','MarkerFaceColor',parula(3)); hold on
load("DATA_08.mat")
scatter(Y_08(1,:),Y_08(2,:),'MarkerEdgeColor','none','MarkerFaceColor',parula(4)); hold on
load("DATA_09.mat")
scatter(Y_09(1,:),Y_09(2,:),'MarkerEdgeColor','none','MarkerFaceColor',parula(5)); hold on
load("DATA_10.mat")
scatter(Y_10(1,:),Y_10(2,:),'MarkerEdgeColor','none','MarkerFaceColor',parula(6)); hold on
load("DATA_11.mat")
scatter(Y_11(1,:),Y_11(2,:),'MarkerEdgeColor','none','MarkerFaceColor',parula(7)); hold on
load("DATA_12.mat")
scatter(Y_12(1,:),Y_12(2,:),'MarkerEdgeColor','none','MarkerFaceColor',parula(8)); hold on
load("DATA_13.mat")
scatter(Y_13(1,:),Y_13(2,:),'MarkerEdgeColor','none','MarkerFaceColor',parula(9)); hold on
load("DATA_14.mat")
scatter(Y_14(1,:),Y_14(2,:),'MarkerEdgeColor','none','MarkerFaceColor',parula(10)); hold on
load("DATA_15.mat")
scatter(Y_15(1,:),Y_15(2,:),'MarkerEdgeColor','none','MarkerFaceColor',parula(11)); hold on
load("DATA_16.mat")
scatter(Y_16(1,:),Y_16(2,:),'MarkerEdgeColor','none','MarkerFaceColor',parula(12)); hold on
load("DATA_17.mat")
scatter(Y_17(1,:),Y_17(2,:),'MarkerEdgeColor','none','MarkerFaceColor',parula(13)); hold on
load("DATA_18.mat")
scatter(Y_18(1,:),Y_18(2,:),'MarkerEdgeColor','none','MarkerFaceColor',parula(14)); hold on
load("DATA_19.mat")
scatter(Y_19(1,:),Y_19(2,:),'MarkerEdgeColor','none','MarkerFaceColor',parula(15)); hold on
load("DATA_20.mat")
scatter(Y_20(1,:),Y_20(2,:),'MarkerEdgeColor','none','MarkerFaceColor',parula(16)); hold on
load("DATA_21.mat")
scatter(Y_21(1,:),Y_21(2,:),'MarkerEdgeColor','none','MarkerFaceColor',parula(17)); hold on
load("DATA_22.mat")
scatter(Y_22(1,:),Y_22(2,:),'MarkerEdgeColor','none','MarkerFaceColor',parula(18)); hold on
load("DATA_23.mat")
scatter(Y_23(1,:),Y_23(2,:),'MarkerEdgeColor','none','MarkerFaceColor',parula(19)); hold on
load("DATA_24.mat")
scatter(Y_24(1,:),Y_24(2,:),'MarkerEdgeColor','none','MarkerFaceColor',parula(20)); hold on
load("DATA_25.mat")
scatter(Y_25(1,:),Y_25(2,:),'MarkerEdgeColor','none','MarkerFaceColor',parula(21)); hold on
