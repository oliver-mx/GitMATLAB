...
f=figure(1);
f.Position= [117.6667 334.3333 1.4200e+03 999.3334];tiledlayout(2,2);
...
%
nexttile
scatter3(X0(1,:), 10*(X0(1,:)-X0(2,:)),Y1(:,userNumber),m_size,Y1(:,userNumber),'filled');hold on; title('simple SWRO (ideal)'); xlabel('Seawater inlet pressure [bar]'); ylabel('Pressure drop [bar]'); axis equal;view(2); grid on;colormap(cmap);colorbar
xlim([31 70]);ylim([10*delta_p_min 33]);yticks(10:10:30);yticklabels({'\Delta P = 1','\Delta P = 2','\Delta P = 3'})
%nexttile
%scatter3(X0(1,:), 10*(X0(1,:)-X0(2,:)),Y2(:,userNumber),m_size,Y2(:,userNumber),'filled');hold on; title('simple SWRO (with ICP)'); xlabel('Seawater inlet pressure [bar]'); ylabel('Pressure drop [bar]'); axis equal;view(2); grid on;colormap(cmap);colorbar
%xlim([31 70]);ylim([10*delta_p_min 33]);yticks(10:10:30);yticklabels({'\Delta P = 1','\Delta P = 2','\Delta P = 3'})
nexttile
scatter3(X0(1,:), 10*(X0(1,:)-X0(2,:)),Y3(:,userNumber),m_size,Y3(:,userNumber),'filled');hold on; title('simple SWRO (ICP+ECP)'); xlabel('Seawater inlet pressure [bar]'); ylabel('Pressure drop [bar]'); axis equal;view(2); grid on;colormap(cmap);colorbar
xlim([31 70]);ylim([10*delta_p_min 33]);yticks(10:10:30);yticklabels({'\Delta P = 1','\Delta P = 2','\Delta P = 3'})
scatter([A1(1,:) A2(1,:) A3(1,:) A4(1,:) A5(1,:)], 10.*[(A1(1,:)-A1(2,:)) (A2(1,:)-A2(2,:)) (A3(1,:)-A3(2,:)) (A4(1,:)-A4(2,:)) (A5(1,:)-A5(2,:)) ],5,'k');hold on
nexttile
scatter3(X0(1,:), 10*(X0(1,:)-X0(2,:)),Y4(:,userNumber),m_size,Y4(:,userNumber),'filled');hold on; title('SWRO+ERD (ideal)'); xlabel('Seawater inlet pressure [bar]'); ylabel('Pressure drop [bar]'); axis equal;view(2); grid on;colormap(cmap);colorbar
xlim([31 70]);ylim([10*delta_p_min 33]);yticks(10:10:30);yticklabels({'\Delta P = 1','\Delta P = 2','\Delta P = 3'})
%nexttile
%scatter3(X0(1,:), 10*(X0(1,:)-X0(2,:)),Y5(:,userNumber),m_size,Y5(:,userNumber),'filled');hold on; title('SWRO+ERD (with ICP)'); xlabel('Seawater inlet pressure [bar]'); ylabel('Pressure drop [bar]'); axis equal;view(2); grid on;colormap(cmap);colorbar
%xlim([31 70]);ylim([10*delta_p_min 33]);yticks(10:10:30);yticklabels({'\Delta P = 1','\Delta P = 2','\Delta P = 3'})
nexttile
scatter3(X0(1,:), 10*(X0(1,:)-X0(2,:)),Y6(:,userNumber),m_size,Y6(:,userNumber),'filled');hold on; title('SWRO+ERD (ICP+ECP)'); xlabel('Seawater inlet pressure [bar]'); ylabel('Pressure drop [bar]'); axis equal;view(2); grid on;colormap(cmap);colorbar
xlim([31 70]);ylim([10*delta_p_min 33]);yticks(10:10:30);yticklabels({'\Delta P = 1','\Delta P = 2','\Delta P = 3'})
...
f=figure(1); f.Position= [578.3333 778.3333 1.5567e+03 487.3333];tiledlayout(1,2);
nexttile
scatter(Y1(:,1),Y1(:,2),'r');hold on; title('ideal permeate flows'); xlabel('SEC_{net} [kWh/m^3]'); ylabel('FW [m^3/h]');
...
%xlim([-10 0]);ylim([0 2.2]);
nexttile
scatter(Y3(:,1),Y3(:,2),'r');hold on; title('nonideal permeate flows (ICP+ECP)'); xlabel('SEC_{net} [kWh/m^3]'); ylabel('FW [m^3/h]');
